-- ========================================================================
-- FINAL COMPLETE DATABASE SCHEMA FOR CAREER ADVISOR PLATFORM
-- ========================================================================
-- Run this entire file in Supabase SQL Editor to create everything at once
-- ✅ Consistent snake_case naming (user_id, career_goal, current_level, etc.)
-- ✅ All RLS policies using correct column names
-- ✅ Performance indexes
...
CREATE INDEX idx_career_roadmaps_created_at ON public.career_roadmaps(created_at DESC);
...
CREATE INDEX idx_outreach_drafts_user_id ON public.outreach_drafts(user_id);
...
CREATE INDEX idx_colleges_rating ON public.colleges(rating DESC);

-- GIN indexes for JSONB columns
CREATE INDEX idx_career_roadmaps_content ON public.career_roadmaps USING GIN (content);
CREATE INDEX idx_quiz_results_answers ON public.quiz_results USING GIN (answers);
CREATE INDEX idx_activities_details ON public.activities USING GIN (details);
