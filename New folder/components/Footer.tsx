...
const Footer = () => {
  ...
  const footerLinks = {
    product: [
      { name: translations.footer.features, href: '#features' },
      { name: translations.features.careerQuiz.name, href: '#quiz' },
      { name: translations.features.careerTree.name, href: '#career-map' },
      { name: translations.features.collegeFinder.name, href: '#colleges' },
      { name: 'Timeline Tracker', href: '#timeline' }
    ],
    company: [
      { name: translations.footer.about, href: '/about' },
      { name: translations.footer.team, href: '/team' },
      { name: 'Careers', href: '/careers' },
      { name: translations.footer.press, href: '/press' },
      { name: translations.footer.contact, href: '/contact' }
    ],
    resources: [
      { name: translations.footer.help, href: '/help' },
    ...
    legal: [
      { name: translations.footer.privacy, href: '/privacy' },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-6 border-t border-glass-border">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            >
              © {currentYear} CareerGuide. {translations.footer.copyright} Built with ❤️ for students everywhere.
            </motion.p>
