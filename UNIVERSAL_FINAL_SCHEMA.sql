...
CREATE TABLE IF NOT EXISTS public.career_roadmaps (
    ...
    duration_months INTEGER NOT NULL DEFAULT 12, -- months
    roadmap_data JSONB NOT NULL DEFAULT '{}', -- stores AI-generated roadmap steps, nodes, and connections
...
CREATE INDEX IF NOT EXISTS idx_career_roadmaps_content ON public.career_roadmaps USING GIN (roadmap_data);
